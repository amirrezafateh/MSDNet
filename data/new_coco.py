...
class DatasetNewCOCO(Dataset):
    ...
    def load_frame(self):
        ...
        query_img = Image.open(os.path.abspath(os.path.join(self.base_path, query_name))).convert('RGB')
        ...
        for support_name in support_names:
            ...
            support_imgs.append(Image.open(os.path.abspath(os.path.join(self.base_path, support_name))).convert('RGB'))
