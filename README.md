...
Note: These ResNet backbones differ from the regular ResNets. To manage complexity, the feature map size is reduced to a fixed value (default 60x60xC) early in the network, and all subsequent feature maps maintain this size. Also, for the multi-scaling part, uncomment the two sections indicated in the msd.py file.
